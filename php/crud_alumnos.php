...
try {
  ...
  switch ($opcion) {
    ...
    case '4': // LISTAR
      $sql = "SELECT ID_ALUMNO, NOMBRES, APELLIDOS, DNI_ALUMNO, 
              FECHA_NACIMIENTO, CELULAR, CORREO, ESTADO
              FROM ALUMNO ORDER BY ID_ALUMNO DESC";
